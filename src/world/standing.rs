...
use super::{TerrainRead, World, ReplicaWorld};
...
impl StandingTerrain for World {
    fn prepare_standing_chunk(&mut self, position: ChunkPos) { self.ensure_chunk(position); }
}
impl StandingTerrain for ReplicaWorld {
    fn prepare_standing_chunk(&mut self, _position: ChunkPos) {}
}

pub(super) fn settle(terrain: &mut impl StandingTerrain, want: crate::planet::EntityPos) -> crate::planet::EntityPos {
