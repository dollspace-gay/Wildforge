...
impl Game {
    pub(in crate::game) fn stage_capture_ice(&mut self, spawn: EntityPos, chart: DemoChart) {
    ...
    pub(in crate::game) fn stage_capture_glowglass(&mut self, spawn: EntityPos, chart: DemoChart) {
    ...
    pub(in crate::game) fn stage_capture_rock(&mut self, spawn: EntityPos, chart: DemoChart) {
    ...
    pub(in crate::game) fn stage_capture_corner(&mut self, spawn: EntityPos, chart: DemoChart) {
    ...
    pub(in crate::game) fn stage_capture_pool(&mut self, spawn: EntityPos, chart: DemoChart) {
