...
impl Game {
    ...
    pub(super) fn exchange_container_slot(&mut self, pos: crate::planet::BlockPos, slot: usize, right: bool, panel: ContainerPanel) {
    ...
    pub(in crate::game) fn chest_click(&mut self, pos: crate::planet::BlockPos, slot: usize, right: bool) {
        self.exchange_container_slot(pos, slot, right, ContainerPanel::Chest);
    }

    pub(in crate::game) fn furnace_click(&mut self, pos: crate::planet::BlockPos, slot: usize, right: bool) {
