...
impl Generator {
    pub(crate) fn geography(&self) -> &Geography {
        &self.geography
    }

    #[cfg(test)]
    pub fn pluton_at_surface(&self, pos: SurfacePos) -> bool {
        self.geography.pluton_at_surface(pos)
    }
    pub fn prospect_at(&self, pos: SurfacePos) -> super::ProspectReading {
        self.geography.prospect_at(pos)
    }
    ...
    pub fn heart_biome_at(&self, pos: SurfacePos) -> Biome {
        self.geography.heart_biome_at(pos)
    }
    pub fn heart_nearness_at(&self, pos: SurfacePos) -> f32 {
        self.geography.heart_nearness_at(pos)
    }
    #[cfg(test)]
    ...
    pub(super) fn is_badlands(climate: &Climate) -> bool {
        Geography::is_badlands(climate)
    }

    #[cfg(test)]
    pub fn climate(&self, x: i32, z: i32) -> Climate {
        self.geography.climate(x, z)
    }
    #[cfg(test)]
    pub fn biome(&self, x: i32, z: i32) -> Biome {
        self.geography.biome(x, z)
    }
    #[cfg(test)]
    pub fn tectonics(&self, x: i32, z: i32) -> Tectonics {
        self.geography.tectonics(x, z)
    }
    #[cfg(test)]
    pub fn province(&self, x: i32, z: i32) -> Province {
        self.geography.province(x, z)
    }
    #[cfg(test)]
