...
use crate::renderer::{SHADOW_RES, SHADOW_CASCADES, MAX_PT_LIGHTS, PT_SHADOW_RES, OCC_GRID};
...
pub(super) fn create(device: &wgpu::Device) -> ShadowTargets {
    ...
    ShadowTargets { shadow_layer_views, shadow_view, shadow_sampler, pt_face_views, pt_tr_faces, pt_shadow_depth, pt_cube_view, pt_tr_view, pt_sampler, occ_tex, occ_view }
}
