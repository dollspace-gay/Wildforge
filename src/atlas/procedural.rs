//! Deterministic procedural art for the built-in atlas tiles.
//!
//! This module is intentionally larger than the usual file-size guardrail:
//! `build_procedural` is one ordered pixel recipe whose shared noise helpers
//! and slot writes must stay together to keep the built-in atlas stable.
